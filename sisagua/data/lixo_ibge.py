...
#     if len_ibge == 6:
#         print(f'Padrão IBGE antigo, com código de 6 dígitos.\nSem correções necessárias.')
#         id_ibge_adjusted = int(id_ibge)
#         print(f'Código IBGE: {id_ibge_adjusted}')
#
#     elif len_ibge == 7:
#         print(f'Padrão IBGE novo, com código de 7 dígitos.\nCorreções necessárias aplicadas!')
#         id_ibge_adjusted = int(id_ibge[0:6])
#         print(f'Código IBGE: {id_ibge_adjusted}')
#
#     else:
#         print(f'Padrão Diferente!\nDesenvolver correção!')
#
